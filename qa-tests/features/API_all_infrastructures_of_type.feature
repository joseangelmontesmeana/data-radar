...
Feature: [data-radar] API queries (All infrastructures of a type) - use_cases (3.2 - 3.6 - 3.10 - 3.14 - 3.18 - 3.22 - 3.26)
  ...
  @<use_case_ref> @all_infrastructures @all_<infrastructures> @all_<infrastructures>_all_information
  ...
  @<use_case_ref> @all_infrastructures @all_<infrastructures> @all_<infrastructures>_one_field
  ...
  @<use_case_ref> @all_infrastructures @all_<infrastructures> @all_<infrastructures>_several_fields
