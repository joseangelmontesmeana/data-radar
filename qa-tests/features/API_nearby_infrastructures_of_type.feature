...
Feature: [data-radar] API queries (Nearby infrastructures of a type) - use_cases (3.3 - 3.7 - 3.11 - 3.15 - 3.19 - 3.23 - 3.27)
  ...
  @<use_case_ref> @nearby_infrastructures @nearby_<infrastructures> @nearby_<infrastructures>_all_information
  ...
  @<use_case_ref> @nearby_infrastructures @nearby_<infrastructures> @nearby_<infrastructures>_one_field
  ...
  @<use_case_ref> @nearby_infrastructures @nearby_<infrastructures> @nearby_<infrastructures>_several_fields
