...
Feature: [data-radar] API queries (To a specific infrastructure) - use_cases (3.1 - 3.5 - 3.9 - 3.13 - 3.17 - 3.21 - 3.25)
  ...
  @<use_case_ref> @specific_infrastructure @specific_<infrastructure> @specific_<infrastructure>_all_information
  ...
  @<use_case_ref> @specific_infrastructure @specific_<infrastructure> @specific_<infrastructure>_does_not_exist
  ...
  @<use_case_ref> @specific_infrastructure @specific_<infrastructure> @specific_<infrastructure>_one_field
  ...
  @<use_case_ref> @specific_infrastructure @specific_<infrastructure> @specific_<infrastructure>_several_fields
